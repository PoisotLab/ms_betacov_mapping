...
(Phyllostomidae), and free-tailed bats (Molossidae).\textsuperscript{18}
...
continents.\textsuperscript{19} Recent surveillance\textsuperscript{20}
...
bridge hosts like livestock,\textsuperscript{21,22} and human population
density and connectivity\textsuperscript{1,23,24}
...
pandemic.\textsuperscript{25--27} Similarly, the SARS-CoV outbreak began
...
province;\textsuperscript{28} nearby, antibody evidence has indicated
human exposure to SARS-like viruses.\textsuperscript{29} MERS-CoV was
originally detected in Saudi Arabia, accompanied by a nearly identical
virus sequenced from an Egyptian tomb bat (\emph{Taphozous
perforatus})\textsuperscript{30}, but is widespread in camels in East
Africa and the Middle East, and may have reached its bridge host decades
earlier than originally supposed;\textsuperscript{31} as a result, the
geography of the original bat-to-camel transmission is still widely
regarded as uncertain. All of these are broadly consistent with the risk
factors we identify. Notably, India and west Africa are additional
hotspots that have yet to experience the emergence of a bat coronavirus
into human populations, but may still be at risk---particularly given
known gaps in bat surveillance,\textsuperscript{17} and a dense
...
wildlife contact)\textsuperscript{32} for maximum impact.
...
health.\textsuperscript{33,34} Chiropterans emerged around 64 million
...
\leavevmode\hypertarget{ref-Olival2020PosZoo}{}%
\CSLLeftMargin{18. }
...
\leavevmode\hypertarget{ref-Rulli2021LanUse}{}%
\CSLLeftMargin{21. }
