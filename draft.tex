...
(Molossidae).\textsuperscript{\textbf{Olival2020PosZoo?}} The former two
...
bridge hosts like
livestock,\textsuperscript{20,\textbf{Rulli2021LanUse?}} and human
population density and connectivity\textsuperscript{1,21,22}
...
characterized prior to the pandemic.\textsuperscript{23--25} Similarly,
...
horseshoe bats in Yunnan province;\textsuperscript{26} nearby, antibody
evidence has indicated human exposure to SARS-like
viruses.\textsuperscript{27} MERS-CoV was originally detected in Saudi
Arabia, accompanied by a nearly identical virus sequenced from an
Egyptian tomb bat (\emph{Taphozous perforatus})\textsuperscript{28}, but
...
supposed;\textsuperscript{29} as a result, the geography of the original
...
contact)\textsuperscript{30} for maximum impact.
...
health.\textsuperscript{31,32} Chiropterans emerged around 64 million
years ago and are one of the most diverse mammalian orders, with an
estimated richness of more than 1400 species.\textsuperscript{33,34}
...
ecosystem-derived benefits to human.\textsuperscript{35} For example,
bats are an essential component of many seed-dispersal
networks.\textsuperscript{36} Over two-thirds of bats are know to be
either obligate or facultative insectivores, therefore actively
contributing for agricultural pest control,\textsuperscript{37,38} and
vectors of pathogens that put a risk on human
health.\textsuperscript{39,40} Because bats are globally distributed and
...
lineage).\textsuperscript{41} Both of these regions are priority areas
...
novel diseases,\textsuperscript{45} so does the changes in landscape
connectivity at local/regional scales.\textsuperscript{46} This
...
encounters.\textsuperscript{47} In particular, the challenge ahead lies
...
data.\textsuperscript{48} The range maps were subsequently rasterized
using the \texttt{rasterize} function from
\texttt{GDAL}\textsuperscript{49} at a resolution of approximately
...
Diversity\textsuperscript{50} based on a recent synthetic tree with
robust time calibration, covering about 6000 mammalian
species.\textsuperscript{51} Faith's PD measures the sum of unique
...
Beta-Diversity;\textsuperscript{52} LCBD works from a species-data
...
location, and following best practices\textsuperscript{53} transformed
...
community. Recent results by\textsuperscript{54} shows that LCBD
...
mammals.\textsuperscript{55} This network stores pairwise values of
...
model.\textsuperscript{56} In this approach, every risk component gets
...
and low viral sharing,\textsuperscript{57} in that this allows multiple
...
extraction,\textsuperscript{58} we measured the risk level by
...
MAFFT\textsuperscript{59} v1.4.0 (Algorithm FFT-NS-2, Scoring matrix
200PAM / k=2, gap open penalty 1.53m offset value 0.123) and a maximum
likelihood tree reconstructed in IQ-TREE\textsuperscript{60} v1.6.12
with ModelFinder\textsuperscript{61} ultrafast bootstrap
approximation\textsuperscript{62} with a general time reversible model
...
distinctiveness\textsuperscript{63} for each of the viruses in the tree,
...
this idea, we loosely adapted a method from,\textsuperscript{64,65} who
...
cophenetic function in \texttt{ape};\textsuperscript{66} subsequently,
