...
superficial proxy for spillover risk,\textsuperscript{2--4} these
...
viruses.\textsuperscript{5} In the case of generalist pathogens like
...
important,\textsuperscript{6} particularly given that cross-species
transmission may, as a rule, structure viral evolution more than
co-divergence with hosts.\textsuperscript{7} This creates a disconnect
...
therefore areas of concern for human health.\textsuperscript{2,19}
...
have been sampled most intensively).\textsuperscript{24} The hotspots of
...
through host switching within this clade\textsuperscript{3,20}. In
...
ancient.\textsuperscript{3,25} While comparatively understudied, New
...
hosts (and their diverse immune strategies)\textsuperscript{27} creates
...
species in both African and Asian continents,\textsuperscript{28} as one
such hotspot; interestingly, a recent study\textsuperscript{29} reported
...
contact with bridge hosts like livestock,\textsuperscript{30,31} and
human population density and connectivity\textsuperscript{1,32,33}
...
pandemic.\textsuperscript{21--23} Similarly, the SARS-CoV outbreak began
...
province;\textsuperscript{34} nearby, antibody evidence has indicated
human exposure to SARS-like viruses.\textsuperscript{35} MERS-CoV was
...
than originally supposed;\textsuperscript{36} as a result, the geography
...
bat surveillance,\textsuperscript{24} and a dense population in both
...
viruses,\textsuperscript{19} bat coronaviruses,\textsuperscript{2} and
even specifically betacoronaviruses\textsuperscript{20} in both the
...
codivergence in Latin America.\textsuperscript{2,46} In contrast, in
...
betacoronaviruses.\textsuperscript{20,24} However, both the evolutionary
...
region.\textsuperscript{32,48} Bats---and the spillover of their
...
domesticated species.\textsuperscript{30,49--51} This represents a
...
a win-win intervention for both.\textsuperscript{53--55}
...
Apr.~2022,\textsuperscript{20} and filtered it to ``known'' hosts
...
\emph{Nature communications} \textbf{13}, 1--12 (2022).}
...
\leavevmode\hypertarget{ref-Caraballo2022CroTra}{}%
\CSLLeftMargin{46. }
