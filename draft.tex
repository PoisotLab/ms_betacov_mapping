...
gradients in bat species richness generally track broader patterns of
...
hotspots of viral diversity, and therefore areas of concern for human
health.\textsuperscript{2,13} However, the hotspots of bat
...
situated primarily South-Eastern Asia, parts of Southern Europe, and to
a lesser extent parts of Africa in the -25-0 range of latitudes (Fig. 1;
...
the creation of novel interactions,\textsuperscript{15} and therefore
...
Yinpterochiroptera elsewhere.\textsuperscript{16,17} Specifically, we
...
the Phyllostomidae,\textsuperscript{18} which is restricted to the
...
unconfirmed hosts of betacoronaviruses,\textsuperscript{14} which would
...
discovered,\textsuperscript{2,13,19} resulting in sparser phylogenetic
...
that underwent explosive diversification events,\textsuperscript{18}
...
congruence.\textsuperscript{20,21} In particular, this should be the
...
species.\textsuperscript{22} Immune characteristics that allow bats to
be better adapted to infection by emerging
viruses,\textsuperscript{23,24} in addition to being hardcoded in their
genome,\textsuperscript{25} may be related to a wide variety of
diets,\textsuperscript{22,26} themselves likely to be driven by spatial
...
environments.\textsuperscript{27}
...
human exposure to SARS-like viruses;\textsuperscript{28} MERS-CoV in
Saudi Arabia based on index cases available from a recently-published
compendium of cases.\textsuperscript{29} For the latest event, most if
...
Haiti\textsuperscript{30} and Europe\textsuperscript{31} are not
...
continents.\textsuperscript{32} Recent surveillance\textsuperscript{33}
...
widely.\textsuperscript{34} Since human activity is required to amplify
...
looking for the origins of SARS in China,\textsuperscript{35} present
...
sampling gaps for \emph{Betacoronavirus},\textsuperscript{36} stressing
...
health.\textsuperscript{20,21} Chiropterans emerged around 64 million
years ago and are one of the most diverse mammalian orders, with an
estimated richness of more than 1400 species.\textsuperscript{37,38}
...
ecosystem-derived benefits to human.\textsuperscript{39} For example,
bats are an essential component of many seed-dispersal
networks.\textsuperscript{40} Over two-thirds of bats are know to be
either obligate or facultative insectivores, therefore actively
contributing for agricultural pest control,\textsuperscript{41,42} and
vectors of pathogens that put a risk on human
health.\textsuperscript{43,44} Because bats are globally distributed and
...
recombination (see \emph{e.g.},\textsuperscript{45} as well as the
...
hosts of undiscovered betacoronaviruses.\textsuperscript{14,36} However,
...
novel diseases,\textsuperscript{49} so does the changes in landscape
connectivity at local/regional scales.\textsuperscript{50} This
...
encounters.\textsuperscript{51} In particular, the challenge ahead lies
...
data.\textsuperscript{52} The range maps were subsequently rasterized
using the \texttt{rasterize} function from
\texttt{GDAL}\textsuperscript{53} at a resolution of approximately
...
Diversity\textsuperscript{54} based on a recent synthetic tree with
robust time calibration, covering about 6000 mammalian
species.\textsuperscript{55} Faith's PD measures the sum of unique
...
Beta-Diversity;\textsuperscript{56} LCBD works from a species-data
...
location, and following best practices\textsuperscript{57} transformed
...
community. Recent results by\textsuperscript{58} shows that LCBD
...
mammals.\textsuperscript{59} This network stores pairwise values of
...
model.\textsuperscript{60} In this approach, every risk component gets
...
and low viral sharing,\textsuperscript{61} in that this allows multiple
...
extraction,\textsuperscript{62} we measured the risk level by
...
MAFFT\textsuperscript{63} v1.4.0 (Algorithm FFT-NS-2, Scoring matrix
200PAM / k=2, gap open penalty 1.53m offset value 0.123) and a maximum
likelihood tree reconstructed in IQ-TREE\textsuperscript{64} v1.6.12
with ModelFinder\textsuperscript{65} ultrafast bootstrap
approximation\textsuperscript{66} with a general time reversible model
...
distinctiveness\textsuperscript{67} for each of the viruses in the tree,
...
this idea, we loosely adapted a method from,\textsuperscript{68,69} who
...
cophenetic function in \texttt{ape};\textsuperscript{70} subsequently,
