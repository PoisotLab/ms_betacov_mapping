...
Coevolution\textsuperscript{7} to provide a measure of risk accounting
...
continents.\textsuperscript{\emph{e.g.} 36} Recent
surveillance\textsuperscript{37} has identified a novel
...
with recent results from\textsuperscript{40} -- areas of purported high
