...
(\textbf{Becker2020InfInt?}, \textbf{Mull2022VirIso?}). Similarly, host
...
case many viruses in the betacoronavirus genus, see \emph{e.g.}
\textbf{MacLean2021NatSel?}), there is conceptual and empirical support
to the idea that these community-level mechanisms are even more
...
threaten human health (\textbf{Letko2020BatVir?},
\textbf{VanBrussel2022ZooDis?}). Chiropterans emerged around 64 million
years ago and are one of the most diverse mammalian orders, with an
estimated richness of more than 1400 species (Peixoto et al. 2018,
...
seed-dispersal networks (\textbf{Mello2011MisPar?}). Over two-thirds of
bats are know to be either obligate or facultative insectivores,
therefore playing an important role in the regulation of insect pests
that can affect crops (Williams-Guillén et al. 2008, Voigt and Kingston
2016), and vectors of pathogens that put a risk on human health
(Gonsalves et al. 2013a, b). Because bats are globally distributed and
