...
Amazon basin) and a secondary hotspot centered in Indochina. These
hotspots of bat diversity are generally presumed to be hotspots of viral
adaptive radiation, and therefore areas of concern for human
health.\textsuperscript{2,18} However, the hotspots of known bat
betacoronavirus hosts show a distinct pattern, with primary hotspots
(both in terms of area and higher values) of host richness situated in
...
probability that spillovers become epidemics)\textsuperscript{1}. As a
proxy for both, we finally overlaid the risk component from the
composite map (see above) with the proportion of built land, as a proxy
for a mix of habitat disturbance, potential for bat synanthropy or
contact with bridge hosts like livestock,\textsuperscript{26,27} and
human population density and connectivity\textsuperscript{1,28,29}
...
pandemic.\textsuperscript{30--32} Similarly, the SARS-CoV outbreak began
...
province;\textsuperscript{33} nearby, antibody evidence has indicated
human exposure to SARS-like viruses.\textsuperscript{34} MERS-CoV was
...
than originally supposed;\textsuperscript{35} as a result, the geography
...
bat surveillance,\textsuperscript{20} and a dense population in both
...
species.\textsuperscript{37,38} They exhibit a broad variety of habitat
...
important ecosystem-derived benefits to humans.\textsuperscript{39} Over
...
region.\textsuperscript{28,46} Bats---and the spillover of their
...
domesticated species.\textsuperscript{26,47--49} This represents a
...
a win-win intervention for both.\textsuperscript{51--53}
...
\leavevmode\hypertarget{ref-Mendenhall2014PreBio}{}%
\CSLLeftMargin{49. }
...
\leavevmode\hypertarget{ref-Hopkins2021HowIde}{}%
\CSLLeftMargin{51. }
...
\leavevmode\hypertarget{ref-Plowright2021LanUse}{}%
\CSLLeftMargin{52. }
...
\leavevmode\hypertarget{ref-OHHLEP2022OneHea}{}%
\CSLLeftMargin{53. }
